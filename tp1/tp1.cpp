...
void ejercicio1() {
    ...
    cout << "Ingrese el valor del lado del cuadrado en centimetros: ";
    cin >> lado;
    area = lado * lado;
    perimetro = 4 * lado;
    cout << "El perimetro del cuadrado es " << perimetro << "cm" << endl;
    cout << "El area del cuadrado es " << area << "cm2" << endl;
    cout << endl;
...
void ejercicio2() {
    ...
    cin >> ancho;
    cout << "Ingrese el alto del rectangulo en centimetros: ";
    cin >> alto;
    area = ancho * alto;
...
void ejercicio4() {
    cout << "el pseudocodigo del ejercicio 4 es el siguiente:" << endl << endl;
    cout << ""
            ""
            ""
...
void ejercicio8() {
    ...
    cout << "Hay " << segundos << " segundos en " << dias << " dias.\n";
    cout << endl;
